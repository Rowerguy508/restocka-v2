  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        action: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg min-h-[56px] text-base font-semibold",
        success: "bg-status-success text-primary-foreground hover:bg-status-success/90 shadow-sm",
        warning: "bg-status-warning text-primary-foreground hover:bg-status-warning/90 shadow-sm",
      },
      size: {
        ...
        icon: "h-10 w-10",
        touch: "min-h-[48px] min-w-[48px] px-6 py-3",
      },
    },
    defaultVariants: {
      variant: "default",
